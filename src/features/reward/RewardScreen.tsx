...
export function RewardScreen(){
  ...
  return <main className={`screen reward-screen ${settings.reducedMotion?'reduced-motion':''}`}><GameHeader title={reward.tier==='boss'?'Boss Cleared':reward.tier==='elite'?'Elite Spoils':'Battle Reward'} subtitle={`${reward.coins} encounter-scaled coins are secured. ${reward.bossRecovery?'Boss recovery will also restore part of the party.':''}`}/>
