...
import { AFFINITY_GUIDE, MECHANIC_GUIDE, STATUS_GUIDE, EFFECT_GUIDE } from '../../game/content/guide';
...
export function GuidePanel({initial}:{initial?:string}){
  ...
  return <section className="overlay-paper guide-panel" aria-labelledby="guide-title">
    <header className="overlay-heading"><span className="tape-label">FIELD GUIDE</span><h2 id="guide-title">How the Table Works</h2><p>Rules and effects in plain language.</p></header>
