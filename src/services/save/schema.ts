import { z } from 'zod';
import type { SaveEnvelopeV1 } from '../../game/core/save/saveFormat';
...
export const SaveEnvelopeSchema=z.object({schemaVersion:z.literal(1),timestamp:z.string(),revision:z.number().int().nonnegative(),payload:z.object({activeRun:run.nullable(),profile,settings})});
export function parseSaveEnvelope(value:unknown):SaveEnvelopeV1{return SaveEnvelopeSchema.parse(value) as SaveEnvelopeV1;}
