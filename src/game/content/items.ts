...
export const ITEMS: ItemDefinition[] = [
  {id:'patch-kit',name:'Patch Kit',description:'Restore 35% Max HP to one ally.',target:'ally-one',price:16,rarity:'common',category:'recovery',effects:[{kind:'healPercent',percent:0.35}]},
  {id:'pp-tonic',name:'PP Tonic',description:'Restore 4 PP to the lowest-PP move of one ally.',target:'ally-one',price:18,rarity:'common',category:'resource',effects:[{kind:'restorePP',amount:4}]},
  {id:'field-ration',name:'Field Ration',description:'Restore 14% Max HP to the whole party.',target:'ally-all',price:24,rarity:'uncommon',category:'recovery',effects:[{kind:'healPartyPercent',percent:0.14}]},
